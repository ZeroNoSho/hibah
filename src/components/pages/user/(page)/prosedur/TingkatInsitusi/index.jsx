...
export default function ProsedurTingkatInsitusi({ e, i, data, status }) {
  return (
    <div className="w-[200px] max-md:mx-auto text-center">
      <Paragraph className="text-center text-[16px] font-[500]">
        STEP {i + 1}
      </Paragraph>
      ...
      <div className="w-[168px] h-[103px] my-8 mx-auto">
        <Paragraph className="text-[12px] font-[500]">{e.head}</Paragraph>
        <Paragraph className="text-[12px] font-[400]">{e.data}</Paragraph>
      </div>
